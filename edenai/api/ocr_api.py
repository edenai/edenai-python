...
class OCRApi(object):
    ...
    def async_ocr_tables_launch(self, language, files, providers, **kwargs):  # noqa: E501
        ...
        The Async OCR Table API allows customers to analyze multi-page documents containing tables and return structured representation of said tables in the form of a Json object  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**English (US)**|`string`|`en-US`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**German**|`string`|`de-DE`| |**French**|`string`|`fr-FR`| |**Italian**|`string`|`it-IT`| |**Spanish**|`string`|`es-ES`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Google Cloud**|`google`| `DocumentAI v1 beta3`  |**Microsoft Azure**|`microsoft`| `rest API 3.0`  |**Amazon Web Services**|`amazon`| `boto3 (v1.15.18)`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def ocr_cv(self, files, providers, **kwargs):  # noqa: E501
        """ocr_cv  # noqa: E501

        The OCR CV API allows customers to analyze resumes and CVsand return structured representation of the candidate profile & experiences  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Hrflow**|`hrflow`| `hrflow 1.9.0`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ocr_cv(files, providers, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param file files: File to analyse (ex: pdf, doc, docs, rtf, png, jpg) (required)
        :param str providers: Providers to compare (ex: [ 'affinda', 'hrflow']) (required)
        :return: InlineResponse2005
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.ocr_cv_with_http_info(files, providers, **kwargs)  # noqa: E501
        else:
            (data) = self.ocr_cv_with_http_info(files, providers, **kwargs)  # noqa: E501
            return data

    def ocr_cv_with_http_info(self, files, providers, **kwargs):  # noqa: E501
        """ocr_cv  # noqa: E501

        The OCR CV API allows customers to analyze resumes and CVsand return structured representation of the candidate profile & experiences  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Hrflow**|`hrflow`| `hrflow 1.9.0`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ocr_cv_with_http_info(files, providers, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('files' not in params or
                                                       params['files'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `files` when calling `ocr_cv`")  # noqa: E501
        # verify the required parameter 'providers' is set
        if self.api_client.client_side_validation and ('providers' not in params or
                                                       params['providers'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `providers` when calling `ocr_cv`")  # noqa: E501

        if self.api_client.client_side_validation and ('providers' in params and
                                                       len(params['providers']) < 1):
            raise ValueError("Invalid value for parameter `providers` when calling `ocr_cv`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def ocr_invoice(self, files, providers, language, **kwargs):  # noqa: E501
        ...
        The OCR Invoice API enables customers to take invoices in a variety of formats and return structured data to automate the invoice processing.  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**English(US)**|`string`|`en-US`| |**French**|`string`|`fr-FR`| |**Spanish**|`string`|`es-ES`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Mindee**|`mindee`| `v2`  |**Dataleon**|`dataleon`| `v3.1.0`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
