...
class OCRApi(object):
    ...
    def async_ocr_tables_launch(self, language, files, providers, **kwargs):  # noqa: E501
        ...
        The Async OCR Table API allows customers to analyze multi-page documents containing tables and return structured representation of said tables in the form of a Json object  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**Spanish**|`string`|`es-ES`| |**English (US)**|`string`|`en-US`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**Italian**|`string`|`it-IT`| |**French**|`string`|`fr-FR`| |**German**|`string`|`de-DE`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Google Cloud**|`google`| `DocumentAI v1 beta3`  |**Microsoft Azure**|`microsoft`| `rest API 3.0`  |**Amazon Web Services**|`amazon`| `boto3 (v1.15.18)`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def ocr(self, files, providers, language, **kwargs):  # noqa: E501
        ...
        Optical Character Recognition or optical character reader (OCR) is the electronic or mechanical conversion of images of typed, handwritten or printed text into machine-encoded text, whether from a scanned document, a photo of a document  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**Spanish**|`string`|`es-ES`| |**Dutch (Netherlands)**|`string`|`nl-NL`| |**German**|`string`|`de-DE`| |**Japanese**|`string`|`ja-JP`| |**Greek**|`string`|`gr-GR`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**Czech**|`string`|`cz-CZ`| |**Korean**|`string`|`ko-KR`| |**Arabic**|`string`|`ar-XA`| |**Chinese-Traditional**|`string`|`zh-TW`| |**Polish**|`string`|`pl-PO`| |**Hungarian**|`string`|`hu-HU`| |**Chinese-Simplified**|`string`|`zh-CN`| |**Turkish**|`string`|`tr-TR`| |**English (US)**|`string`|`en-US`| |**Russian**|`string`|`ru-RU`| |**Italian**|`string`|`it-IT`| |**Finnish**|`string`|`fn-FN`| |**French**|`string`|`fr-FR`| |**Swedish**|`string`|`sw-SW`| |**Danish**|`string`|`da-DK`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Google Cloud**|`google`| `v1`  |**Microsoft Azure**|`microsoft`| `v3.2`  |**Amazon Web Services**|`amazon`| `boto3 (v1.15.18)`  |**Tesseract**|`tesseract`| `latest`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def ocr_invoice(self, files, providers, language, **kwargs):  # noqa: E501
        ...
        The OCR Invoice API enables customers to take invoices in a variety of formats and return structured data to automate the invoice processing.  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**Spanish**|`string`|`es-ES`| |**English (US)**|`string`|`en-US`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**Italian**|`string`|`it-IT`| |**French**|`string`|`fr-FR`| |**Danish**|`string`|`da-DK`| |**German**|`string`|`de-DE`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Mindee**|`mindee`| `v2`  |**Dataleon**|`dataleon`| `v3.1.0`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
