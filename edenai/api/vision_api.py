...
class VisionApi(object):
    ...
    def explicit_content_detection_with_http_info(self, files, providers, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('providers' in params and
            ...
            raise ValueError("Invalid value for parameter `providers` when calling `explicit_content_detection`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def face_detection_with_http_info(self, files, providers, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('providers' in params and
                                                       len(params['providers']) < 1):
            raise ValueError("Invalid value for parameter `providers` when calling `face_detection`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def object_detection_with_http_info(self, files, providers, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('providers' in params and
                                                       len(params['providers']) < 1):
            raise ValueError("Invalid value for parameter `providers` when calling `object_detection`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
