...
class TextApi(object):
    ...
    def keyword_extraction(self, language, text, providers, **kwargs):  # noqa: E501
        ...
        Keyword extraction (also known as keyword detection or keyword analysis) is a text analysis technique that consists of automatically extracting the mostimportant words and expressions in a text.  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**Spanish**|`string`|`es-ES`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**Italian**|`string`|`it-IT`| |**German**|`string`|`de-DE`| |**Finnish**|`string`|`fn-FN`| |**French**|`string`|`fr-FR`| |**Swedish**|`string`|`sw-SW`| |**English (US)**|`string`|`en-US`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Microsoft Azure**|`microsoft`| `v3.1`  |**Amazon Web Services**|`amazon`| `boto3 (v1.15.18)`  |**IBM Watson**|`ibm`| `v1 (2021-08-01)`  |**Lettria**|`lettria`| `v5.5.2`   # noqa: E501
    ...
    def named_entity_recognition(self, language, text, providers, **kwargs):  # noqa: E501
        ...
        Named Entity Recognition (also called entity identification or entity extraction) is an information extraction technique that automatically identifies named entities in a text and classifies them into predefined categories.  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**Arabic**|`string`|`ar-XA`| |**Spanish**|`string`|`es-ES`| |**Chinese-Traditional**|`string`|`zh-TW`| |**Japanese**|`string`|`ja-JP`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**Italian**|`string`|`it-IT`| |**German**|`string`|`de-DE`| |**Finnish**|`string`|`fn-FN`| |**Dutch (Netherlands)**|`string`|`nl-NL`| |**Chinese-Simplified**|`string`|`zh-CN`| |**French**|`string`|`fr-FR`| |**Swedish**|`string`|`sw-SW`| |**Korean**|`string`|`ko-KR`| |**English (US)**|`string`|`en-US`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Amazon Web Services**|`amazon`| `boto3 (v1.15.18)`  |**IBM Watson**|`ibm`| `v1 (2021-08-01)`  |**Google Cloud**|`google`| `v1`  |**Lettria**|`lettria`| `v5.5.2`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def sentiment_analysis(self, language, text, providers, **kwargs):  # noqa: E501
        ...
        Sentiment analysis API extracts sentiment in a given string of text.Sentiment analysis, also called 'opinion mining',uses natural language processing, text analysis and computational linguistics to identify and detect subjective information from the input text.  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**Arabic**|`string`|`ar-XA`| |**Spanish**|`string`|`es-ES`| |**Chinese-Traditional**|`string`|`zh-TW`| |**Japanese**|`string`|`ja-JP`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**Italian**|`string`|`it-IT`| |**German**|`string`|`de-DE`| |**Dutch (Netherlands)**|`string`|`nl-NL`| |**Chinese-Simplified**|`string`|`zh-CN`| |**French**|`string`|`fr-FR`| |**Korean**|`string`|`ko-KR`| |**English (US)**|`string`|`en-US`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Microsoft Azure**|`microsoft`| `v3.1`  |**Amazon Web Services**|`amazon`| `boto3 (v1.15.18)`  |**IBM Watson**|`ibm`| `v1 (2021-08-01)`  |**Lettria**|`lettria`| `v5.5.2`  |**Connexun**|`connexun`| `v1.0`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def syntax_analysis(self, language, text, providers, **kwargs):  # noqa: E501
        ...
        Syntax analysis consists principaly in highlighting the structure of a text.  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**Arabic**|`string`|`ar-XA`| |**Spanish**|`string`|`es-ES`| |**Chinese-Traditional**|`string`|`zh-TW`| |**Japanese**|`string`|`ja-JP`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**Italian**|`string`|`it-IT`| |**German**|`string`|`de-DE`| |**Finnish**|`string`|`fn-FN`| |**Dutch (Netherlands)**|`string`|`nl-NL`| |**Chinese-Simplified**|`string`|`zh-CN`| |**French**|`string`|`fr-FR`| |**Swedish**|`string`|`sw-SW`| |**Korean**|`string`|`ko-KR`| |**English (US)**|`string`|`en-US`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Amazon Web Services**|`amazon`| `boto3 (v1.15.18)`  |**IBM Watson**|`ibm`| `v1 (2021-08-01)`  |**Lettria**|`lettria`| `v5.5.2`  |**Google Cloud**|`google`| `v1`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
