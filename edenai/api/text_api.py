...
class TextApi(object):
    ...
    def keyword_extraction(self, language, text, providers, **kwargs):  # noqa: E501
        ...
        Keyword extraction (also known as keyword detection or keyword analysis) is a text analysis technique that consists of automatically extracting the mostimportant words and expressions in a text.  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**Swedish**|`string`|`sw-SW`| |**English (US)**|`string`|`en-US`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**German**|`string`|`de-DE`| |**French**|`string`|`fr-FR`| |**Italian**|`string`|`it-IT`| |**Finnish**|`string`|`fn-FN`| |**Spanish**|`string`|`es-ES`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Microsoft Azure**|`microsoft`| `v3.1`  |**Amazon Web Services**|`amazon`| `boto3 (v1.15.18)`  |**IBM Watson**|`ibm`| `v1 (2021-08-01)`  |**Lettria**|`lettria`| `v5.5.2`   # noqa: E501
    ...
    def syntax_analysis(self, language, text, providers, **kwargs):  # noqa: E501
        ...
        Syntax analysis consists principaly in highlighting the structure of a text.  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**Japanese**|`string`|`ja-JP`| |**Swedish**|`string`|`sw-SW`| |**English (US)**|`string`|`en-US`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**German**|`string`|`de-DE`| |**Chinese-Traditional**|`string`|`zh-TW`| |**Arabic**|`string`|`ar-XA`| |**Korean**|`string`|`ko-KR`| |**French**|`string`|`fr-FR`| |**Dutch (Netherlands)**|`string`|`nl-NL`| |**Chinese-Simplified**|`string`|`zh-CN`| |**Italian**|`string`|`it-IT`| |**Finnish**|`string`|`fn-FN`| |**Spanish**|`string`|`es-ES`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Amazon Web Services**|`amazon`| `boto3 (v1.15.18)`  |**IBM Watson**|`ibm`| `v1 (2021-08-01)`  |**Lettria**|`lettria`| `v5.5.2`  |**Google Cloud**|`google`| `v1`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
