...
class TranslationApi(object):
    ...
    def automatic_translation(self, text, source_language, target_language, providers, **kwargs):  # noqa: E501
        ...
        Machine translation refers to the translation of a text into another language using rules, statics or ml technics.  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**Portuguese (Brazil)**|`string`|`pt-BR`| |**Spanish**|`string`|`es-ES`| |**Malay**|`string`|`ms-MY`| |**Japanese**|`string`|`ja-JP`| |**Russian**|`string`|`ru-RU`| |**Italian**|`string`|`it-IT`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**German**|`string`|`de-DE`| |**Dutch (Netherlands)**|`string`|`nl-NL`| |**English (GB)**|`string`|`en-GB`| |**French**|`string`|`fr-FR`| |**Indonesian**|`string`|`id-ID`| |**Arabic (Saudi Arabia)**|`string`|`ar-SA`| |**Korean**|`string`|`ko-KR`| |**Turkish**|`string`|`tr-TR`| |**English (US)**|`string`|`en-US`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Microsoft Azure**|`microsoft`| `v3.0`  |**Amazon Web Services**|`amazon`| `boto3 (v1.15.18)`  |**Google Cloud**|`google`| `v3`   # noqa: E501
