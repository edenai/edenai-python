...
class PipelinesApi(object):
    ...
    def pipelines(self, description, text, files, **kwargs):  # noqa: E501
        """pipelines  # noqa: E501
        ...
        >>> thread = api.pipelines(description, text, files, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.pipelines_with_http_info(description, text, files, **kwargs)  # noqa: E501
        else:
            (data) = self.pipelines_with_http_info(description, text, files, **kwargs)  # noqa: E501
            return data

    def pipelines_with_http_info(self, description, text, files, **kwargs):  # noqa: E501
        """pipelines  # noqa: E501

        Pipelines let you combine different AI APIs from different providers into a single ready to use pipeline that you can run on your data.   **AVAILABLE FEATURES**   |Feature                   |Value|Can be first|Can be followed by| |--------------------------|-----------------------|------------|------------------| |**OCR**                     |`ocr`                  |`True`      |Sentiment Analysis, Syntax Analysis, Keyword Analysis, Named Entity Recognition, Text to speech, Translation,  Language Detection  | |**Translation**             |`automatic_translation`|`True`      |Sentiment Analysis, Syntax Analysis, Keyword Analysis, Named Entity Recognition, Text to speech                                    | |**Speech recognition**      |`speech_to_text`       |`True`      |Sentiment Analysis, Syntax Analysis, Keyword Analysis, Named Entity Recognition, Text to speech, Translation,  Language Detection  | |**Sentiment Analysis**      |`sentiment_analysis`   |`False`     |None                                                                                                                               | |**Syntax Analysis**         |`syntax_analysis`      |`False`     |None                                                                                                                               | |**Keyword Analysis**        |`keyword_extraction`   |`False`     |None                                                                                                                               | |**Named Entity Recognition**|`language_detection`   |`False`-    |None                                                                                                                               | |**Language Detection**      |`language_detection`   |`False`     |None                                                                                                                               | |**Text to speech**          |`text_to_speech`       |`False`     |None                                                                                                                               |   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.pipelines_with_http_info(description, text, files, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['description', 'text', 'files']  # noqa: E501
        ...
        if ('text' not in params or
                params['text'] is None):
            raise ValueError("Missing the required parameter `text` when calling `pipelines`")  # noqa: E501
        # verify the required parameter 'files' is set
        if ('files' not in params or
                params['files'] is None):
            raise ValueError("Missing the required parameter `files` when calling `pipelines`")  # noqa: E501
