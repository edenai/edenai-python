...
class SpeechApi(object):
    ...
    def speech_to_text(self, language, files, providers, **kwargs):  # noqa: E501
        ...
        Speech recognition is technology that can recognize spoken words, which can then be converted to text.  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**Portuguese (Brazil)**|`string`|`pt-BR`| |**Spanish**|`string`|`es-ES`| |**Malay**|`string`|`ms-MY`| |**Japanese**|`string`|`ja-JP`| |**Russian**|`string`|`ru-RU`| |**Italian**|`string`|`it-IT`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**German**|`string`|`de-DE`| |**Dutch (Netherlands)**|`string`|`nl-NL`| |**English (GB)**|`string`|`en-GB`| |**French**|`string`|`fr-FR`| |**Indonesian**|`string`|`id-ID`| |**Arabic (Saudi Arabia)**|`string`|`ar-SA`| |**Korean**|`string`|`ko-KR`| |**Turkish**|`string`|`tr-TR`| |**English (US)**|`string`|`en-US`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Amazon Web Services**|`amazon`| `boto3 (v1.15.18)`  |**Deepgram**|`deepgram`| `v1`  |**IBM Watson**|`ibm`| `v1`  |**Speechmatics**|`speechmatics`| `2.7.0`  |**Microsoft Azure**|`microsoft`| `v1.0`  |**Google Cloud**|`google`| `v1p1beta1`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def text_to_speech(self, text, language, option, providers, **kwargs):  # noqa: E501
        ...
        Text-to-speech (TTS) system converts normal language text into speech.  **SUPPORTED LANGUAGE**  |Name|Type|Value| |----|----|-----| |**Arabic**|`string`|`ar-XA`| |**Portuguese (Brazil)**|`string`|`pt-BR`| |**Spanish**|`string`|`es-ES`| |**Japanese**|`string`|`ja-JP`| |**Portuguese (Portugal)**|`string`|`pt-PT`| |**Italian**|`string`|`it-IT`| |**German**|`string`|`de-DE`| |**Russian**|`string`|`ru-RU`| |**Dutch (Netherlands)**|`string`|`nl-NL`| |**English (GB)**|`string`|`en-GB`| |**French**|`string`|`fr-FR`| |**Danish**|`string`|`da-DK`| |**Chinese**|`string`|`cmn-CN`| |**English (US)**|`string`|`en-US`|  **AVAILABLE PROVIDERS**   |Name|Value|Version| |----|-----|-------| |**Microsoft Azure**|`microsoft`| `v1.0`  |**Amazon Web Services**|`amazon`| `boto3 (v1.15.18)`  |**Google Cloud**|`google`| `v1`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
